...
export default function Home() {
  ...
  const fetchOfferListings = async () => {
    try {
      const res = await axios.get(' https://rentandcapture-backend.onrender.com/api/listing/get?offer=true');
      const data = res.data;
  ...
  const fetchRentListings = async () => {
    try {
      const res = await axios.get(' https://rentandcapture-backend.onrender.com/api/listing/get?type=rent');
      const data = res.data;
